...
const Experience = (props) => {
    ...
    return (
        <>
            {/* <div id="experience" ref={expRef} className={"h-96 overflow-hidden flex-col sm:flex-row dark:text-light"}> */}
            <div id="experience" className={"flex-col sm:flex-row dark:text-light"}>
