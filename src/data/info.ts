  ...
  experience: [
    {
      ...
      description: [
        "Development of Front End React web applications capable of 3D rendering, using Three.js.",
    ...
    },
    {
      ...
      description: [
        "Front End development using Microsoft .NET following MVC pattern with ASP.NET Razor, C# .NET, Ajax and Bootstrap.",
    ...
    },
    {
      ...
      description: [
        "Migration of services developed in FoxPro to Windows Services and Applications using Microsoft .NET, with C# .NET, LinQ and Crystal Report.",
    ...
    },
    {
      ...
      description: [
        "Front End development using Microsoft .NET following MVC pattern with ASP.NET Razor, C# .NET and VB .NET",
